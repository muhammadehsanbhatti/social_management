                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12 icon_div" style="display: {{ $icon_display }};">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('icon', isset($data->asset_type) && $data->asset_type == 'Icon' ? $data->asset_value: 'menu')}}" type="text" id="icon" class="form-control @error('asset_value') is-invalid @enderror" placeholder="Icon Name" name="asset_value">
                                            @error('asset_value')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
