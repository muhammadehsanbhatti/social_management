                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ isset($data->id) ? 'Update' : 'Add' }}
                                    {{ !isset($data->user_role) && isset($data->id) ? 'Profile' : 'User Detail' }}</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input
                                                value="{{ old('first_name', isset($data->first_name) ? $data->first_name : '') }}"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input
                                                value="{{ old('last_name', isset($data->last_name) ? $data->last_name : '') }}"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('email', isset($data->email) ? $data->email : '') }}"
                                                type="email" id="email"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('country', isset($data->country) ? $data->country : '') }}"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input
                                                value="{{ old('phone_number', isset($data->phone_number) ? $data->phone_number : '') }}"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ old('dob', isset($data->dob) ? $data->dob : '') }}"
                                                type="date" id="dob"
                                                    ...
                                                    <div class="display_images preview_profile_image">
                                                        @if (isset($data->profile_image) && !empty($data->profile_image))
                                                            <a data-fancybox="demo"
                                                                data-src="{{ is_image_exist($data->profile_image) }}"><img
                                                                    title="{{ $data->name }}"
                                                                    src="{{ is_image_exist($data->profile_image) }}"
                                                                    height="100"></a>
                                                        @endif
                                                    </div>
                                                </span>
                                            </div>
                                            <input type="file" id="profile_image" data-img-val="preview_profile_image"
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('role') is-invalid @enderror"
                                                    ...
                                                    <option value="User"
                                                        {{ isset($data->role) && $data->role == 'User' ? 'selected' : '' }}>
                                                        User</option>
                                                    <option value="Employee"
                                                        {{ isset($data->role) && $data->role == 'Employee' ? 'selected' : '' }}>
                                                        Employee</option>
                                                </select>
                                                @error('role')
                                                    <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('address') is-invalid @enderror" placeholder="Enter address" name="address"
                                                id="address" value="{{ old('address', isset($data->address) ? $data->address : '') }}">{!! isset($data->address) ? $data->address : '' !!}</textarea>
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" placeholder="Enter description"
                                                name="description" id="description"
                                                value="{{ old('description', isset($data->description) ? $data->description : '') }}">{!! isset($data->description) ? $data->description : '' !!}</textarea>
                                            @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
